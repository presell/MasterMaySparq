...
import sty from "./PlasmicSqueeze.module.css"; // plasmic-import: aZJUqEsmc1wDvb/css
            ...
            <ph.DataCtxReader>
              {$ctx => (
                <React.Fragment>
                  ...
                  >
                    <div
                      className={classNames(projectcss.all, sty.columns__s7HHn)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__v6Il9)}
                  >
                    <SqueezeForm
                      className={classNames(
                        "__wab_instance",
                        sty.squeezeForm__z71Di
                      )}
                    />
                  </div>
                  <PlasmicHead
                    ...
                    >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <p.PlasmicImg
                                  alt={""}
                                  className={classNames(sty.img__a433V)}
                                  displayHeight={"175px" as const}
                                  displayMaxHeight={"none" as const}
                                  displayMaxWidth={"100%" as const}
                                  displayMinHeight={"0" as const}
                      ...
                      {true ? (
                        ...
                        >
                          <p.PlasmicImg
                            alt={""}
                            className={classNames(sty.img__hgYi3)}

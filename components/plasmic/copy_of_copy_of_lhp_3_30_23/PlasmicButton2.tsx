...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: ipIedihqf1cRC/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__xir31)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__i1OGo)}
                role={"img"}
              />
            ),

...
import sty from "./PlasmicCollection1.module.css"; // plasmic-import: _ePJquMzW8mMEg/css
...
function PlasmicCollection1__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___3Uvoq)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__cNbNm)}
              ...
              src={{
                src: "/plasmic/copy_of_copy_of_lhp_3_30_23/images/productVariety1C2E7Bd9Ac9C4989Bfad811526Dad7E0250X2502Xjpgpng.png",
                fullWidth: 387,
                fullHeight: 442,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__zex8W)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__tkfXu)}>
        {p.renderPlasmicSlot({
          defaultContents: "★★★★★ (447)",
          value: args.slot2,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__pLoL)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox___9X2Ix)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__q6MEc)}>
        {p.renderPlasmicSlot({
      ...
      >
        <div className={classNames(projectcss.all, sty.column__ilwdW)}>
          <div className={classNames(projectcss.all, sty.freeBox__nF01U)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img___9U0H5)}
                  displayHeight={"auto" as const}
                  displayMaxHeight={"none" as const}
                  displayMaxWidth={"100%" as const}
                  displayMinHeight={"0" as const}
                  ...
                  loading={"lazy" as const}
                  src={{
                    src: "/plasmic/copy_of_copy_of_lhp_3_30_23/images/labelsvg.svg",
                    fullWidth: 150,
                    fullHeight: 150,
                    aspectRatio: 1
                  }}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__nl7OE)}>
              {p.renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.column__ioygv)}>
          <div className={classNames(projectcss.all, sty.freeBox__okNo0)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__oa2Uk)}
                  displayHeight={"auto" as const}
                  displayMaxHeight={"none" as const}
                  displayMaxWidth={"100%" as const}
                  displayMinHeight={"0" as const}
                  ...
                  loading={"lazy" as const}
                  src={{
                    src: "/plasmic/copy_of_copy_of_lhp_3_30_23/images/labelsvg2.svg",
                    fullWidth: 150,
                    fullHeight: 150,
                    aspectRatio: 1
                  }}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__ktSgs)}>
              {p.renderPlasmicSlot({

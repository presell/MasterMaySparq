...
import sty from "./PlasmicNavLogoOnly.module.css"; // plasmic-import: NTg4eYbqEyMIt6/css
        ...
        {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
          ...
          >
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__ln8QE)} />
            ) : null}
            <div className={classNames(projectcss.all, sty.column___2Ked)}>
              <p.PlasmicLink
            ...
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__gydc)} />
            ) : null}
          </div>
        ) : null}
      </div>

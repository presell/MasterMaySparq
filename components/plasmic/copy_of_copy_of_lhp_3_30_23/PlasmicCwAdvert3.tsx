...
import sty from "./PlasmicCwAdvert3.module.css"; // plasmic-import: dD42IkglJIq3U/css
...
function PlasmicCwAdvert3__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.columns__u6Duz)}>
          <div className={classNames(projectcss.all, sty.column___02Dc8)}>
            <p.PlasmicLink
              className={classNames(
                projectcss.all,
                projectcss.a,
          ...
          <div className={classNames(projectcss.all, sty.column__l0Om)}>
            <div
      ...
      >
                  ...
                  return __wrapUserFunction(
                    {
                      ...
                      interactionUuid: "DZ-HrgCvdGg844-",
                      componentUuid: "dD42IkglJIq3U"
                    },
                    () =>
        ...
        <div className={classNames(projectcss.all, sty.freeBox__jsFex)}>
          <p.PlasmicImg
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__vqXvo)}>
          <div
          ...
          >
            ...
            <div className={classNames(projectcss.all, sty.freeBox___4VY5A)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___4Ob52)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            >
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__p5X55)}
                displayHeight={"auto" as const}
                displayMaxHeight={"none" as const}
                displayMaxWidth={"100%" as const}
                displayMinHeight={"0" as const}
            ...
            >
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__iT1V)}
                displayHeight={"auto" as const}
                displayMaxHeight={"none" as const}
                displayMaxWidth={"100%" as const}
                displayMinHeight={"0" as const}
            ...
            >
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__tlY2M)}
                displayHeight={"auto" as const}
                displayMaxHeight={"none" as const}
                displayMaxWidth={"100%" as const}
                displayMinHeight={"0" as const}
            ...
            >
              ...
              >
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__c9NpY)}
                  displayHeight={
                    hasVariant(globalVariants, "screen", "mobileOnly")
                      ? ("auto" as const)
                      : ("422px" as const)
            ...
            <div className={classNames(projectcss.all, sty.freeBox__pdqgp)}>
              <div
            ...
            <div className={classNames(projectcss.all, sty.freeBox__w6TuL)}>
              <div
            ...
            <div className={classNames(projectcss.all, sty.freeBox__kkOEk)}>
              <div
            ...
            <div className={classNames(projectcss.all, sty.freeBox__mbNK)}>
              <div
            ...
            <div className={classNames(projectcss.all, sty.freeBox__tuMTx)}>
              <div
            ...
            <div className={classNames(projectcss.all, sty.freeBox__mgBis)}>
              <p.PlasmicLink
              ...
              <div className={classNames(projectcss.all, sty.freeBox__kqwto)} />

              <div className={classNames(projectcss.all, sty.freeBox__itnPs)}>
                <div
          ...
          <div className={classNames(projectcss.all, sty.freeBox__x87M)}>
            <div className={classNames(projectcss.all, sty.freeBox___3BlfL)}>
              <p.PlasmicImg
            ...
            <div className={classNames(projectcss.all, sty.freeBox__adjKc)}>
              <p.PlasmicImg
            ...
            <div className={classNames(projectcss.all, sty.freeBox__d2Wy4)}>
              <p.PlasmicImg
            ...
            <div className={classNames(projectcss.all, sty.freeBox__xpL4W)}>
              <p.PlasmicImg
        ...
        {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.columns__yumRx)}
          >
            {(
              hasVariant(globalVariants, "screen", "mobileOnly") ? true : true
            ) ? (

...
import sty from "./PlasmicOffer1.module.css"; // plasmic-import: tIy_v0PVRisw56/css
...
function PlasmicOffer1__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___7P3Oy)}>
        <div className={classNames(projectcss.all, sty.freeBox__o3WEs)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__tboqg)}
      ...
      <div className={classNames(projectcss.all, sty.freeBox__xAPoY)}>
        <div
        ...
        <div className={classNames(projectcss.all, sty.freeBox__g0QIk)}>
          {p.renderPlasmicSlot({
            defaultContents:
        ...
        <div className={classNames(projectcss.all, sty.freeBox___9XmIs)}>
          {p.renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.freeBox__hteWb)}>
          <div className={classNames(projectcss.all, sty.freeBox__uEgQg)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__mlFfs)}
          ...
          <div className={classNames(projectcss.all, sty.freeBox__geOG)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__vfIrk)}
                    displayHeight={"60px" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}

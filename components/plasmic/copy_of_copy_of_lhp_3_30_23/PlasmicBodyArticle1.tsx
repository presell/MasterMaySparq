...
import sty from "./PlasmicBodyArticle1.module.css"; // plasmic-import: tATSIvg-wEr20C/css
...
function PlasmicBodyArticle1__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__lqJr1)}
        component={Link}
        href={(() => {
          try {
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__hL9Z)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link___2GflO)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__vFvww)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__wjoMt)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__moXpu)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__gzEok)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column__cfnKw)}>
              <p.PlasmicLink
                className={classNames(
                  projectcss.all,
                  projectcss.a,
            ...
            <div className={classNames(projectcss.all, sty.column__lX84I)}>
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__cf6Ye)}
                displayHeight={
                  hasVariant(globalVariants, "screen", "mobileOnly")
                    ? ("70%" as const)
                    : ("80%" as const)
                ...
                loading={"lazy" as const}
                src={{
                  src: "/plasmic/copy_of_copy_of_lhp_3_30_23/images/_4F0Afe7D15505Bfe240E785E7Ac88B6Cwebp.webp",
                  fullWidth: 3,
                  fullHeight: 90,
            ...
            <div className={classNames(projectcss.all, sty.column__jLjtf)}>
              <div
              ...
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img___3VlHn)}
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__p7Mza)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
